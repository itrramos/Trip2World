 ...
 * Admin API client.
 *
 * Points at the admin panel's OWN origin (`admin.trip2world.net/api`), which Caddy proxies
 ...
 * `admin.trip2world.net` and is never attached to a request made by code running on
 * `trip2world.net`. A cross-site scripting flaw in the public bundle therefore cannot
